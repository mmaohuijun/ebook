<style lang="less">
    ...
    .field_tool .ivu-tooltip {
        margin-right: 8px;
        font-size: 16px;
        cursor: pointer;
    }

    .ivu-card-body:hover .field_tool {
        opacity: 1;
    }
...
<template>
    <div class="layout-content">
        <Tabs value="name1">
            ...
            <Tab-pane label="项目信息" icon="ios-paper" name="name2">
                <!-- 敬请期待 -->
                <Row :gutter="16">
            ...
            <Tab-pane label="维度信息" icon="ios-body" name="name3">敬请期待</Tab-pane>
        </Tabs>
    </div>
</template>
<script>
