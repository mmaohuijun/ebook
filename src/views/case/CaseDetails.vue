...
<div class="layout__content">
  <div class="layout__header">
    <h2 class="layout__header-title">案场管理 - {{caseName}}</h2>
  </div>
            ...
            <div class="ivu-tabs-nav-wrap">
              <div class="ivu-tabs-nav-scroll">
                <div class="ivu-tabs-nav">
                  ...
                  <div v-for="(item, index) in tabsList" :key="index" class="ivu-tabs-tab" :class="[item.pathName === currentPathName ? 'ivu-tabs-tab-active' : '', caseId === '0' && index !== 0 ? 'ivu-tabs-tab-disabled' : '']" @click="onClickTabs(item.pathName)">{{item.title}}</div>
                </div>
              </div>
            </div>
          </div>
